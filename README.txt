...
Send an HTTPS request to www.redscraper.com/sub add the following HTTP variables as necessary.
...
EXAMPLE: www.redscraper.com/?subreddit=all&limit=11&time=month
